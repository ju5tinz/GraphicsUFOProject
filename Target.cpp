...
Target::Target(std::string objFilename, GLuint shaderProgram, glm::mat4 model) :
...
void Target::update(glm::mat4 translate) {
	model = glm::scale(glm::mat4(1.0f), glm::vec3(100.0f, 100.0f, 100.0f)) * translate;
}